...
public class OnlineShoppingTest {
	...
	@BeforeTest
	  ...
	  htmlReporter= new ExtentHtmlReporter("C:\\Users\\TRAINING_B6B.00.10\\Desktop\\reports\\casereport3.html");
	 ...
	 driver.findElement(By.id("userName")).sendKeys("qazxswedc"+val);
	 driver.findElement(By.id("firstName")).sendKeys("Subhadip");
	 driver.findElement(By.id("lastName")).sendKeys("Bhatt");
	 driver.findElement(By.id("password")).sendKeys("subhadip123");
	 driver.findElement(By.id("pass_confirmation")).sendKeys("subhadip123");
